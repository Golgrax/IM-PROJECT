...
def open_admin_dashboard(admin_name, login_window):
    ...
    scrollable_frame = ttk.Frame(canvas, padding="0")
    ...
    btn_frame = ttk.Frame(scrollable_frame, padding="5")
    ...
    ttk.Button(logout_frame, text="Logout", command=confirm_logout, style="Dark.TButton", width=20).pack(pady=5)
